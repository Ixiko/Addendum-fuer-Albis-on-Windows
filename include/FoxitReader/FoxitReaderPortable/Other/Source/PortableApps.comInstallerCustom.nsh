!macro CustomCodePostInstall
	...
	${EndIf}
	${If} ${FileExists} "$INSTDIR\Data\settings\FoxitReaderPortable.reg"
	${AndIfNot} ${FileExists} "$INSTDIR\Data\settings\FoxitReaderPortable9.reg"
		CopyFiles /SILENT "$INSTDIR\App\DefaultData\settings\FoxitReaderPortable9.reg" "$INSTDIR\Data\settings"
	${EndIf}
!macroend