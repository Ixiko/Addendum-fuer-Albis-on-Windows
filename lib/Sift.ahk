...
;	3) {Options}		IN	    	Needle anywhere IN Haystack item (Default = IN)
...
;
; 	Note:
;		Sift_Regex searchs are all RegExMatch searches with Needles crafted based on the options chosen
;
; =============================================================================================
...
;	1) {Haystack}				String or array of information to search, ByRef for efficiency but Haystack is not changed by function
;   2) {Needle}					String providing search text or criteria, ByRef for efficiency but Needle is not changed by function
;	3) {Delta}						(Default = .7) Fuzzy match coefficient, 1 is a perfect match, 0 is no match at all, only results above the Delta are returned
