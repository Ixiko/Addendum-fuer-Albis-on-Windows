...
global initialSQL := "SELECT * FROM Patient"
global databaseType := "dbf"
...
connectionString := "Driver={Microsoft dBASE Driver (*.dbf)};DriverID=277;Dbq=\\server\daten\albiswin\Db_011018;|Provider=Microsoft.Jet.OLEDB.4.0;Data Source=\\server\daten\albiswin\Db_011018;Extended Properties=dBASE IV;User ID=Admin;Password="";|Provider=Microsoft.Jet.OLEDB.4.0;User ID=Admin;Data Source=\\server\daten\albiswin\Db_011018;Mode=Share Deny None;Extended Properties=dBase 5.0;Jet OLEDB:System database="";Jet OLEDB:Registry Path="";Jet OLEDB:Database Password="";Jet OLEDB:Engine Type=18;Jet OLEDB:Database Locking Mode=0;Jet OLEDB:Global Partial Bulk Ops=2;Jet OLEDB:Global Bulk Transactions=1;Jet OLEDB:New Database Password="";Jet OLEDB:Create System Database=False;Jet OLEDB:Encrypt Database=False;Jet OLEDB:Don't Copy Locale on Compact=False;Jet OLEDB:Compact Without Replica Repair=False;Jet OLEDB:SFP=False;"

;Data Source=" A_ScriptDir "\Test\TestDB.mdb"
...
Gui, Add, ComboBox, x+0 ym w400 vddDatabaseConnection, % connectionString
...
#Include %A_ScriptDir%\Collection.ahk
#Include %A_ScriptDir%\ArchLogger.ahk
#Include %A_ScriptDir%\MemoryBuffer.ahk
#Include %A_ScriptDir%\Collection.ahk

; drivers / header definitions
#Include %A_ScriptDir%\ADO.ahk
#Include %A_ScriptDir%\SQLite_L.ahk
...
class DBA ; namespace DBA
{
	...
	*/
	...
	;base classes
	#Include %A_ScriptDir%\DataBaseFactory.ahk
	#Include %A_ScriptDir%\DataBaseAbstract.ahk


	; Concrete SQL-Provider Implementations
	#Include %A_ScriptDir%\DataBaseSQLLite.ahk
	#Include %A_ScriptDir%\DataBaseMySQL.ahk
	#Include %A_ScriptDir%\DataBaseADO.ahk

	#Include %A_ScriptDir%\RecordSetSqlLite.ahk
	#Include %A_ScriptDir%\RecordSetADO.ahk
	#Include %A_ScriptDir%\RecordSetMySQL.ahk
}