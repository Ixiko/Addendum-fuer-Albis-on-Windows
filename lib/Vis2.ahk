...
class Vis2 {
   ...
   class provider {
      ...
      class Tesseract {
         ...
         static leptonica     	:= A_ScriptDir "\..\..\include\OCR\leptonica_util\leptonica_util.exe"
         static tesseract      	:= A_ScriptDir "\..\..\include\OCR\tesseract\tesseract.exe"
         static tessdata_best 	:= A_ScriptDir "\..\..\include\OCR\tesseract\tessdata_best"
         static tessdata_fast 	:= A_ScriptDir "\..\..\include\OCR\tesseract\tessdata_fast"
         ...
         convert(in:="", out:="", fast:=1){
            ...
            fast := (fast) ? this.tessdata_best : this.tessdata_fast
            ...
            static q := Chr(0x22)
            ;_cmd .= q this.tesseract q " --tessdata-dir " q fast q " " q in q " " q SubStr(out, 1, -4) q   ; --psm 1 --oem 2
