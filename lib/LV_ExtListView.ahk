...
Specifies or receives the attributes of a list-view item. This structure has
been updated to support a new mask value (LVIF_INDENT) that enables item
indenting. This structure supersedes the LV_ITEM structure.
Note: This structure assumes Windows XP+

    [Member]    [Type]   	[32bitA]  	[32bitU]  	[64bitU]
1   mask        	UINT    [00] 4    	[00] 4    	[00] 4
2   iItem       		int      	[04] 4    	[04] 4    	[04] 4
3   iSubItem    	int      	[08] 4    	[08] 4    	[08] 4
4   state       		UINT   	[12] 4    	[12] 4    	[12] 4
5   stateMask   	UINT  	[16] 4    	[16] 4    	[16] 4
        Structure alignment filler           [20] 4
6   pszText     LPTSTR   [20] 4    [20] 4    [24] 8
7   cchTextMax  int      [24] 4    [24] 4    [32] 4
8   iImage      int      [28] 4    [28] 4    [36] 4
9   lParam      LPARAM   [32] 4    [32] 4    [40] 8
10  iIndent     int      [36] 4    [36] 4    [48] 4
11  iGroupId    int      [40] 4    [40] 4    [52] 4
12  cColumns    UINT     [44] 4    [44] 4    [56] 4
13  puColumns   UINT     [48] 4    [48] 4    [60] 4
                              ---       ---       ---
                              52        52        64

#if (_WIN32_WINNT >= 0x0600)  ;-- Vista+
14  piColFmt    int      [52] 4    [52] 4    [64] 4
15  iGroup      int      [56] 4    [56] 4    [68] 4
#endif
                              ---       ---       ---
                              60        60        72
...
ExtListView_Initialize(sWnd, szReadBuf:=1024, sEnc:="CP0") {
	...
	If !RegExMatch(sWnd, "^\s*0x[a-f0-9]+") {
		objLV.swnd       	:= sWnd
