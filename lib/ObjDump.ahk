...
/* 		DESCRIPTION of library - ObjDump.ahk 			        (written by HotkeyIt, *last change: see Description)

			----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			Description:						 a fast library to backup any AHK Object (Array or Object) in binary format to harddisk or memory
			----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			Link: 								https://autohotkey.com/boards/viewtopic.php?p=23832
			----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			Autohotkey Version:		AHK v1   - use link to get AHK v2 Version
			----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			UPDATE:							*16.11.2017 	Fix to handle properly keys and values containing numbers and spaces or tabs, Update latest v2 syntax
													*25.02.2016 	Fix ObjLoad bug., ObjDump and ObjLoad can now handle object reference to itself or another object within dumped object.
													*02.11.2015 	Fix saving binary memory of key (use obj.GetAddress(k) instead of &v)
													*20.08.2015 	Include size of dumped object for simplified use, Note wrote: New ObjLoad() function is not compatible to the old functions and cannot load a file dumped with old ObjDump function.
																			You can rename the old ObjLoad function to ObjLoad2 and run this with new ObjDump function: ObjDump(ObjLoad2(File),File)
													20.05.2014		Implemented obj-64 -> file -> obj-32 and the other way round. Use only the required memory for numbers. Additional parameter DumpBuffer,
																			when true obj.GetCapacity(key) is used else StrPut(value)*(A_IsUnicode?2:1)
													18.05.2014		Fixed writing large objects
			----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			Examples:						use link above
			----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
