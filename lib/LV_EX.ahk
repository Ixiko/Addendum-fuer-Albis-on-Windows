...
; ======================================================================================================================
LV_EX_GroupGetCount(HLV, GroupID, ByRef FirstItem := "") {
...
; ======================================================================================================================
; LV_EX_GetItemCount - Retrieves the number of items in a list-view control.
; ======================================================================================================================
LV_EX_GetItemCount(HLV) {
   ; LVM_GETITEMCOUNT := 0x1004 -> https://msdn.microsoft.com/en-us/library/windows/desktop/bb761044(v=vs.85).aspx
...
; ======================================================================================================================
; LV_EX_GetSelectedCount - Retrieves the number of selected items in a list-view.
; ======================================================================================================================
LV_EX_GetSelectedCount(HLV) {
   ; LVM_GETSELECTEDCOUNT := 0x1032 -> https://msdn.microsoft.com/en-us/library/windows/desktop/bb761069(v=vs.85).aspx
   SendMessage, 0x1032, 0, 0, , % "ahk_id " . HLV
   Return ErrorLevel
}
; ======================================================================================================================
...
; ======================================================================================================================
; LV_EX_SetItemStateImage - Sets the state image associated with the item
; ======================================================================================================================
LV_EX_SetItemStateImage(HLV, Row, Index) {
   ; LVM_SETITEMA = 0x1006 -> http://msdn.microsoft.com/en-us/library/bb761186(v=vs.85).aspx
   Static LVIS_STATEIMAGEMASK := 0xF000
   Static OffState := 12
   Static OffStateMask := 16
   LV_EX_LVITEM(LVITEM, LVIF_STATE := 0x8, Row)
   NumPut(Index, LVITEM, OffState, "UInt")
   NumPut(LVIS_STATEIMAGEMASK, LVITEM, OffStateMask, "UInt")
   SendMessage, 0x1006, 0, % &LVITEM, , % "ahk_id " . HLV
   Return ErrorLevel
}
; ======================================================================================================================
