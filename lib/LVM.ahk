/*
  ...
  Flag reference:
	...
	LVNI_PREVIOUS       			0x20   	Microsoft Windows Vista and later: Searches for an item that is ordered before the item specified in plvii.
														The LVNI_PREVIOUS flag is not directional (LVNI_ABOVE will find the item positioned above, while LVNI_PREVIOUS will find the item ordered before.)
														The LVNI_PREVIOUS flag basically reverses the logic of the search performed by the LVM_GETNEXTITEM or LVM_GETNEXTITEMINDEX messages.
...
LVM_Modify(h, r, c=1, o=0, f*) {
	...
	; f* = Fields to modify each column. Each field will be modified in subsequent order starting with the c param. This param is variadic. See: https://ahknet.autohotkey.com/~Lexikos/AutoHotkey_L/docs/Functions.htm#Variadic
...
LVM_Insert(h, r=0, c=1, o=0, f*) {
	...
	; f* = Fields to fill each column. Each field will be inserted in subsequent order starting with the c param. This param is variadic. See: https://ahknet.autohotkey.com/~Lexikos/AutoHotkey_L/docs/Functions.htm#Variadic
