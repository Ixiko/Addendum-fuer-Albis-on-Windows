...
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_ShowBlankInclude							, Show Include Files With No Hotkeys
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_ShowExe											, Show EXE Files (Help Comments Do Not Exist in EXE)
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_AhkExe											, Scan AHK File with Same Name as Running EXE
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_AhkTxt											, Scan Text Files with Same Name as Running Script
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_AhkTxtOver										, Text File Help will Overwrite Duplicate Help
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_ShowHotkey									, Show Created with Hotkey Command
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_VarHotkey										, Attempt to Resolve Variables in Dynamic Hotkeys
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_FlagHotkey										, Flag Hotkeys created with the Hotkey Command with <HK>
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_SortInfo											, Sort by Hotkey Description (Otherwise by Hotkey Name)
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w180 	h30 vSet_CapHotkey										, Hotkey Capitalization
Gui, Set:Add, Radio		 , x240 	yp 		w80 		h30 vSet_CapHotkey_Radio							, Title
Gui, Set:Add, Radio		 , x320 	yp 		w120 	h30																, UPPER
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_ShowString										, Show Hotstrings
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_HideFold										, Hide Fold Start  `;`{  from Help Comment
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w220 	h30 vSet_TextOut											, Automatically Export Help Dialog
Gui, Set:Add, Button		 , x290 	yp 		w135 	h30 gButtonExportDialog Default					, Export Help Dialog
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_IniSet												, Use INI File to Save Settings
Gui, Set:Add, CheckBox	 , x60 	yp+40 	w380 	h30 vSet_IniExcluded										, Use INI File to Save Excluded Files and Hotkeys
Gui, Set:Add, ComboBox, x60 	yp+40 	w60 		h30 R5 Choose1 vSet_Hotkey_Mod_Delimiter	, "%Set_Hotkey_Mod_Delimiter%"|"+"|"-"|" + "|" - "
Gui, Set:Add, Text			 , x130 yp	 		w250 	h30																, Delimiter to Separate Hotkey Modifiers
Gui, Set:Add, Button		 , x60 	yp+60 w330 	h30 Default													, Finished
...
#f1::	;{ <--  ~ Display Help ~
	...
	if Gui_Created
	{
		if !(Display == Previous_Display)
		{
			...
			{
				Gui, Add, Edit, vGui_Display ReadOnly -E0x200 hwndidDisplay, % SubStr(Display,1,32000)
