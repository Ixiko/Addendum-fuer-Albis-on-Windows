...
Eval(x) 					{ ; non-recursive PRE/POST PROCESSING: I/O forms, numbers, ops, ";"
		...
		global xe := 2.718281828459045, xpi := 3.141592653589793 ; referenced as "e", "pi"
		global xinch := 2.54, xfoot := 30.48, xmile := 1.609344 ; [cm], [cm], [Km]
		global xounce := 0.02841, xpint := 0.5682, xgallon := 4.54609 ; liters
		global xoz := 28.35, xlb := 453.59237 ; grams
