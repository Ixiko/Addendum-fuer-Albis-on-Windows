![ahk_logo.png](./ahk_logo.png "ahk_logo.png")
...
▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
###  ![Addendum-Symbol](Icons/Addendum18x18.ico) ***Addendum V1.68***  (05.12.2021)
| Datum | Beschreibung |
|----------------|----------------------------------------------------|
| **05.12.2021** |💉  **Impfstatistik**<br>funktionierende Statistik für COVID19-Schutzimpfungen für das RKI, die Statistik wird als Tabelle<br>dargestellt und die Daten werden ausserdem auf Tastendruck ins KBV Formular übertragen<br>  🖱 **Schaltfläche zum Leeren aller Addressfelder**<br/>        im Dialog 'weitere Informationen' eine Schaltfläche zum einfachen Leeren der Addressfelder bereitgestellt.<br>        Funktion kann zuvor gelöschten Inhalt der Felder wiederherstellen.<br>  ⏰ **Neustart von Albis zum Tageswechsel** <br>         kurz vor 0 Uhr jeden Tages wird Albis beendet und kurz nach 0 Uhr des neuen Tages erneut gestartet. <br>         Ohne Neustart von Albis wird ein Zeitstempel für die TI nicht erneuert. <br>         Angeschlossene Lesegeräte (Telematik) lassen sich am nächsten Tag nicht in Betrieb nehmen. <br> 📅 Verbesserungen beim **Shift-F3 Kalender**.<br>        Es werden wieder Datumsbereiche in die Felder geschrieben. <br> 👪 Einträge im **Fenster 'Familiendaten'**<br>        Verschieben mit Strg & Pfeil hoch oder runter möglich<br> 📝 **Diagnosen-Auswahlbox**<br/>Dialog wird automatisch geschlossen wenn sich der Tastatureingabefokus geändert hat<br> 💡 **Infofenster**<br>        beim Laden einer leeren PDFDaten.json Datei blieb das Skript beim Umwandeln des JSON-Strings in ein <br>       Autohotkey-Objekt hängen. Nachfolgende Aufrufe, wie Hotkeys und Hotstrings, wurden dann nicht ausgeführt. |
|  | ![Telegram.svg](Icons\Telegram.svg) **PushToTelegram**<br/>        eine Erweiterung um EMails von Outlook nach Telegram weiterzuleiten <br> 💡 **Infofenster**<br/>        ▸ Die Tagesprotokolle von jedem anderen Rechner im Praxisnetzwerk lassen sich anzeigen.<br/>        ▸ Laborblattausgabe über PDF-Drucker verbessert<br> <img src="Icons/Laborjournal.png" style="zoom:35%;" />**LaborJournal**<br/>        merkt sich die letzte Änderung der LabParam.dbf um die Anzahl der Parameter und ihre<br/>        Beschreibungen aktuell halten zu können<br> ⌨ **Hotstring-Viewer**<br>        wenn die Suche in den vorab eingegebenen Diagnosen-Hotstrings erfolglos ist, wird automatisch<br/>        im ICD-Katolog gesucht<br |

▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
### ![Addendum-Symbol](Icons/Addendum18x18.ico) **Addendum V1.67**  (26.10.2021)
| Datum | Beschreibung |
|----------------|-----------------------------------------------------|
| **26.10.2021** | 💰 **Abrechnungsassistent**: <br/>     ▸anhand von ICD Diagnosen werden Patienten zur Abrechnung von Chronikerpauschalen vorgeschlagen<br/>     ▸Verbesserung und Erweiterung der grafischen Oberfäche.<br/>     ▸Geschwindigkeit verbessert.<br>     ▸Fehler beseitigt. <br><br> ![Addendum-Symbol](Icons/Addendum18x18.ico) **Addendum V1.66**<br>📧 **MailManager**:<br/>      ▸Vorbereitung für Outlook Automatisierung von Fritz!Box FaxMail Nachrichten  <br><br>![Addendum-Symbol](Icons/Addendum18x18.ico) **Addendum V1.65**<br>💡 **Infofenster**:<br/>    ▸*AutoWartezimmer*: Pat. können anhand bestimmter Stichworte in einer importierten<br/>    ▸Dokumentbezeichnung automatisch einembestimmten Wartezimmer zugeordnet werden,<br/>        z.B. als "ToDo Liste" abzuarbeitender Anfragen<br/><br/>⚗ **Laborabruf**<br/>    ▸Verbesserungen bei den Fenstererkennungen<br><br>⌨ **Kontextabhängige Hotstrings**:⏷*Hotstring-Diagnosen* funktionieren jetzt auch in diversen Formularen:<br>      ▸ Krankenhauseinweisung (Muster 2)<br>      ▸ Überweisung (Muster 6)<br>      ▸ Antrag auf Kostenübernahme Reha-Sport (Muster 56)<br>      ▸ Befundbericht Rehabilitationsanstrag (Muster G1204)<br>      ▸ Ärztliches Gutachten <br> ⏵ **Verwandtschaftsbeziehungen**: im Familiendialog hinzugefügt<br> ⏵ **Laden von Hotstrings**:  Hotstrings können jetzt in externen Dateien abgelegt werden<br> ⏵ **Hotstringhelfer Fenster**: verrutschen der Gui Position ausserhalb des sichtbaren Monitorbereiches wird verhindert<br> ⏵ **Hotkeys und Hotkeyfunktionen**: verbessert<br><br/>⌨ **Scite4AutoHotkey** - die Größe des Output pane ist wird entsprechend der Monitororientierung (Hochformat/Querformat) angepasst<br> |

▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
### ![Addendum-Symbol](Icons/Addendum18x18.ico) ***Addendum V1.64***  (18.09.2021)
| Datum | Beschreibung |
|----------------|-----------------------------------------------------|
| **18.09.2021** | ⏵⚗ **Laborjournal.ahk** <br>- automatischer Start zur festgelegten Zeit, z.B. zum Beginn der Spechstunde. An Tagen ohne Sprechstunde (Wochenende, Urlaub)<br>**AUTOMATISCHES ERSETZEN (HOTSTRINGS):**<br>⏵⌨ **Senden von Diagnosen erweitert**. Cursor wird zur schnelleren Eingabe von z.B. Seitenangaben an   entsprechende die Position im ICD-Code gesetzt.<br>⏵💰 **Senden von Ziffern im Abrechnungsfenster** per Hotkey hinzugefügt. Schnelles Einfügen von Einzelziffern z.B. im Rahmen der Korrekturen bei Abrechnungsprüfung.<br>⏵ ⌨ **Kontextsensitive Hotstringhilfe** hinzugefügt. Die Eingabe eines Sternchen (*) nach einer begonnenen Texteingabestellt ein Suchfenster fürHotstrings in ihrem Kontext bereit. Wurde zuvor nichts eingegeben werden alle HotStrings des jeweiligen Kontext angezeigt (z.B. alle EBModer Diagnosenhotstrings).  <![Addendum-Symbol](Icons/Addendum18x18.ico) **Addendum V1.63**<<br>⏵💰 **Abrechnungsscheinprüfung:**  vor dem Eintragen von Kosten für Kopien (als Sachkosten) wird auf einen angelegten Privat oder BG Schein geprüft<br>⏵ **Portokosten**: nach Eingabe von porto nach den Kürzeln bg oder lbg erscheint jetzt ein Tooltip mit Preisen und Beschreibungen der Deutschen Post AG. Nachfolgend muss nur noch eine Zahl zur Auswahl der richtigen Portokosten gedrückt werden. Die Europreise sind in der Addendum.ini hinterlegt.<br>⏵⌨ **mehr Diagnosenhotstrings**:	Fristenanzeige im AU Formular leicht überarbeitet, Fristen werden in die Karteikarte übernommen<br><br> ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ ͞ <br/>- das Tray-Menu enthält **mehr Einstellungsmöglichkeiten** für Addendum<br/>- **Skript für Organisation des Corona-Impfmanagements** hinzugefügt + Hotstrings für Corona EBM Ziffern.<br/>- Schnellentfernung aus der Wartezimmerliste (Albisdialog wird nach Festlegung automatisch bestätigt)<br/>- 💉**Coronaimpfdokumentation.ahk** - hilft die Dokumentation schneller zu erfassen<br/><br> <u>**Addendum_Gui**</u><br>⏵ Autonaming wird nach jedem Texterkennungsvorgang aufgerufen. <br> der Dateiname des Dokumentes enthält den richtigen Patientennamen und das Erstellungsdatum des Dokumentes<br/>⏵Wiederherstellung der letzten Fensteransicht verbessert<br/>⏵das Laborblatt kann per EMail (Outlook) versendet werden. Die für den Versand benötigte EMail Adresse wird aus der Albis-Datenbank bezogen	(einzutragen unter Stammdaten).<br/>⏵der Dokumentimport hat eine ansehnliche Fortschrittsanzeige erhalten<br/>⏵Autovervollständigung beim Umbennen von Dokumenten<br/>⏵Dateiexport aus dem Journal in den Exportordner<br> |

▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
### ![Addendum-Symbol](Icons/Addendum18x18.ico) ***Addendum V1.60***  (08.04.2021)<br>

| Datum | Beschreibung |
|:--------------:|-----------------------------------------------------|
| **08.04.2021** | **Abrechnungsassistent.ahk**<br>Der Abrechnungsassistent scannt die DBase-Datenbanken nach allen bisherigen Einträgen für Gesundheitsvorsorgen, Hautkrebsscreening, Krebsvorsorge (Männer) Darmkrebsscreening-, Screening des Aortenaneurysma, Chronikerziffern. Dem stellt es dann alle Abrechnungsscheine eines Quartals gegenüber , nutzt die KVB-Abrechnungsregeln und zeigt innerhalb von 4,5s eine Tabelle mit Patienten und potientiell abzurechnenden Untersuchungen für das gewählte Quartal an. Ein Doppelklick auf einen Patienten öffnet seine Karteikarte. Ein weiterer Klick im angezeigten Quartalskalender und die Ziffern werden am gewählten Datum eingetragen. Einfach? Einfach! Schneller als mit Albis? Wesentlich schneller! Ausbaufähig? Definitiv! Ersatz für den Albis Abrechnungsassistenten? Da ich nicht weiß ob dieser nicht doch zuverlässige Ausgaben genieren kann, nur ein "vielleicht". |
|  | 💡<u>**Infofenster**</u>            	<br>- Autovervollständigung für Namen u. Bezeichnungen im Dateidialog fertig gestellt <br>- Fehlerbehebung bei der Dateibehandlung und bei der Anzeige in der Listview <br>![Addendum-Symbol](Icons/Addendum18x18.ico) **Addendum V1.55** |
|  | <u>**Quicksearch**</u>            	<br>-  	für die direkte Suche in den Datenbankdateien mit derzeit schon der Möglichkeit in den Spalten eine RegEx-Suche durchführen zu lassen. Die Suchergebnisse werden in einer eigenen Tabelle ausgegeben bei welcher man in Zukunft ganze Spalten ein- und ausblenden wird können. |
|  | ![Addendum-Symbol](Icons/Addendum18x18.ico) <u>**Addendum**</u>            	<br>- es können etwas mehr Einstellungen über das Traymenu vorgenommen werden.<br>- Funktion für automatisierte Korrektur von EBM-Ausnahmeziffern im Feld Ausnahmeindikation hinzugefügt<br> - mehr Hotstrings für EBM, GOÄ Ziffern und Diagnosen  <![Addendum-Symbol](Icons/Addendum18x18.ico) **Addendum V1.54**> |
|  | <u><img src="Icons/Laborjournal.png" style="zoom:35%;" /> **LaborJournal**</u>        		<br>- HTML schöner gemacht, CSS ToolTip Animation beim Überfahren von Laborparametern mit der Maus (Langtexte der Parameter werden gezeigt)<br>- Unterschreitungen der Normgrenzen sollte jetzt erkannt werden |
|  | ⚗ **Laborabruf_iBWC**   	- 	Protokoll und Ablaufanzeige konsistenter gemacht |
|  | <u><img src="Icons/Laborjournal.png" style="zoom:35%;" /> **LaborJournal**</u><br> - es wurden mehr Parameter im Labor angezeigt als eingestellt war <br>- Zeigt die Laborwerte der letzten n Werktage an. Es kommt somit immer eine feste Anzahl an Tagen zur Darstellung. <br>![Addendum-Symbol](Icons/Addendum18x18.ico) **Addendum V1.53** |
|  | ![Addendum-Symbol](Icons/Addendum18x18.ico) <u>**Addendum**</u><br> - der Auto-Neustart des Skriptes setzt das Albis-Programmdatum wieder auf das aktuelle Tagesdatum<br>- der Dialog 'Labor Anzeigegruppen' wird abgefangen um die Steuerelemente zu vergrößern |
...
|  | 💡 <u>**InfoFenster**</u><br>hat einen weiteren TAB (**Extra**) erhalten über den man Skriptdateien oder Programme starten kann |
