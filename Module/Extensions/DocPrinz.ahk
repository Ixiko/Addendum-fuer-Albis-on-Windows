...
;	Version 1.01
	...
	;-: LISTVIEW PATIENTEN                                  	;{
		...
		LVColumns 	:= "NR|Name|Vorname|Geburtstag|PLZ|Ort|Strasse|Telefon|Arbeit|letzte Beh|timestamp"
...
Dokumente_Export(Patient:="")                            	{	;-- exportiert ausgewählte Dokumente
